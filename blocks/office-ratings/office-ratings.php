...
class RealSatisfied_Office_Ratings_Block {
	...
	public function render_block( $attributes ) {
		...
		if ( $attributes['showOverallRating'] ?? true ) {
			$layout_classes[] = 'has-rating';
		}
		if ( $attributes['showStars'] ?? true ) {
			$layout_classes[] = 'has-stars';
		}
		if ( $attributes['showOfficeName'] ?? true ) {
			$layout_classes[] = 'has-office-name';
		}
		if ( $attributes['showReviewCount'] ?? true ) {
			$layout_classes[] = 'has-review-count';
		}
		if ( $attributes['showTrustBadge'] ?? false ) {
			$layout_classes[] = 'has-trust-badge';
		}
		if ( $attributes['showDetailedRatings'] ?? false ) {
			$layout_classes[] = 'has-detailed-ratings';
		}
