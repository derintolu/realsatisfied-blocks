(function() {
    ...
    registerBlockType('realsatisfied-blocks/agent-testimonials-v2', {
        title: __('Agent Testimonials V2', 'realsatisfied-blocks'),
        ...
        edit: function(props) {
            ...
            return (
                Fragment({},
                    ...
                    ServerSideRender({
                        block: 'realsatisfied-blocks/agent-testimonials-v2',
