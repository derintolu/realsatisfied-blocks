...
class RealSatisfied_Agent_Testimonials_Block {
	...
	public function render_block( $attributes ) {
		...
		if ( empty( $vanity_key ) ) {
			return $this->render_error( __( 'No agent vanity key found. Please set the "realsatisfied-agent-vanity" ACF field for this page, or enter a manual vanity key in the block settings.', 'realsatisfied-blocks' ) );
		}
