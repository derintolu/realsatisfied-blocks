<?php
/**
 * RealSatisfied Agent Testimonials Block V2
 * 
...
/**
 * RealSatisfied Agent Testimonials V2 Block Class
 */
class RealSatisfied_Agent_Testimonials_V2_Block {
     ...
     * @var string
     */
    private $block_name = 'realsatisfied-blocks/agent-testimonials-v2';
    ...
    private function generate_html_output($testimonials, $attributes, $channel_data) {
        ...
        $output = '<div class="realsatisfied-agent-testimonials-v2 layout-' . esc_attr($layout) . '">';
    ...
    private function render_error($message) {
        return '<div class="realsatisfied-agent-testimonials-v2-error notice notice-warning">' .
    ...
    public function enqueue_editor_assets() {
        wp_enqueue_script(
            'realsatisfied-agent-testimonials-v2-editor',
            plugin_dir_url(__FILE__) . 'agent-testimonials-v2-editor.js',
            array('wp-blocks', 'wp-element', 'wp-i18n', 'wp-components', 'wp-data'),
            '1.0.0'
        );

        wp_localize_script('realsatisfied-agent-testimonials-v2-editor', 'realSatisfiedAgentTestimonialsV2', array(
    ...
    public function enqueue_frontend_assets() {
        ...
        wp_add_inline_style(
            'wp-block-library',
            '
            .realsatisfied-agent-testimonials-v2 {
                margin: 20px 0;
            }
            .realsatisfied-agent-testimonials-v2 .testimonials-grid {
                display: grid;
                gap: 20px;
            }
            .realsatisfied-agent-testimonials-v2 .testimonials-grid.columns-1 {
                grid-template-columns: 1fr;
            }
            .realsatisfied-agent-testimonials-v2 .testimonials-grid.columns-2 {
                grid-template-columns: repeat(2, 1fr);
            }
            .realsatisfied-agent-testimonials-v2 .testimonials-grid.columns-3 {
                grid-template-columns: repeat(3, 1fr);
            }
            .realsatisfied-agent-testimonials-v2 .testimonial-item {
                border: 1px solid #ddd;
                padding: 20px;
                border-radius: 5px;
                background: #f9f9f9;
            }
            .realsatisfied-agent-testimonials-v2 .customer-name {
                margin: 0 0 10px 0;
                font-size: 1.1em;
                font-weight: bold;
            }
            .realsatisfied-agent-testimonials-v2 .customer-type {
                margin: 0 0 10px 0;
                font-style: italic;
                color: #666;
            }
            .realsatisfied-agent-testimonials-v2 .testimonial-content {
                margin: 10px 0;
                line-height: 1.5;
            }
            .realsatisfied-agent-testimonials-v2 .testimonial-date {
                margin: 10px 0 0 0;
                font-size: 0.9em;
                color: #888;
            }
            .realsatisfied-agent-testimonials-v2 .stars {
                color: #ffa500;
            }
            .realsatisfied-agent-testimonials-v2-error {
                padding: 10px;
                margin: 10px 0;
